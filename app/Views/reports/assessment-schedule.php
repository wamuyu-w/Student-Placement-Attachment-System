...
<div class="table-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    ...
    <a href="<?= Helpers::baseUrl('/admin/reports/print-assessment-schedule') ?>" target="_blank" class="btn-submit" style="text-decoration: none; font-size: 0.9rem; padding: 10px 16px;">
