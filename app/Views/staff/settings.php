    ...
    <div class="card mb-4">
        ...
        <form action="<?= Helpers::baseUrl('/settings/update-profile') ?>" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <input type="text" name="name" value="<?= htmlspecialchars($profile['Name']) ?>" class="form-control" required style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px;">
            </div>
            <div class="form-group" style="margin-bottom: 15px;">
                <label style="display: block; margin-bottom: 5px; font-weight: 500;">Department</label>
                <input type="text" name="department" value="<?= htmlspecialchars($profile['Department']) ?>" class="form-control" required style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px;">
            </div>
